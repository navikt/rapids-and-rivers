...
internal class JsonMessageTest {
    ...
    fun `create need from map`() {
        ...
        assertEquals(behovsliste, node.path("@behov").mapTo(mutableListOf(), JsonNode::asString))
    ...
    @Test
    fun asOptionalLocalDateTime() {
        assertNull(MissingNode.getInstance().asOptionalLocalDateTime())
