            ...
            fun fromEnv(env: Map<String, String>) = generateInstanceId(env).let { instanceId ->
                RapidApplicationConfig(
                    ...
                    kafkaConfig = KafkaConfig(
                        ...
                        sslTruststoreLocation = env["KAFKA_TRUSTSTORE_PATH"],
                        sslTruststorePassword = env["KAFKA_TRUSTSTORE_PASSWORD"],
                        sslKeystoreLocation = env["KAFKA_KEYSTORE_PATH"],
                        sslKeystorePassword = env["KAFKA_KEYSTORE_PASSWORD"],
